...
namespace TryontechWebAPI.Controllers
{
    ...
    public class ModeloController : ControllerBase
    {
        ...
        public IActionResult AsignarModelo([FromBody] AsignarModeloRequest request)
        {
            ...
            {
                return BadRequest(new { success = false, message = "Ocurrió un error al asignar el modelo. Por favor, verifica los datos enviados e inténtalo nuevamente. Detalle: " + ex.Message });
            }
        }
    }
}
